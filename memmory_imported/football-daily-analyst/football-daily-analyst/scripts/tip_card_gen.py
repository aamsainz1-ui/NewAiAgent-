"""
UFAX9 Tip Card Generator — สร้างการ์ดทีเด็ดบอลแชร์ได้
ใช้ Pillow สร้างรูป PNG พร้อมโลโก้ UFAX9
...
def create_tip_card(home, away, league, kick_time, tip, confidence, extra_info=None, output_path=None):
    ...
    draw.text((W//2, H-85), "ufax9.com", fill=BG_COLOR, font=font_brand, anchor="mm")
...
def create_parlay_card(matches, output_path=None):
    ...
    draw.text((W//2, H-67), "ufax9.com", fill=BG_COLOR, font=font_brand, anchor="mm")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="UFAX9 Tip Card Generator")
